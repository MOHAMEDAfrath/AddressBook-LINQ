...
namespace AddressBook_LINQ
{
    public class GetDataTables
    {
        public static DataTable GetTable()
        {
            ...
            //add rows
            addressbook.Rows.Add(1, "Dhanush", "Raj", "Egmore", "Chennai", "TamilNadu", "600009", 7874157898, "amir.khan@gmail.com");
            addressbook.Rows.Add(2, "Amir", "Khan", "Nungambakam", "Chennai", "TamilNadu", "600077", 7102354045, "Dhanush.raj@gmail.com");
